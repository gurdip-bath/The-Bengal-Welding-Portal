...
interface LoginProps {
  ...
  mode?: 'CUSTOMER' | 'ADMIN' | 'BOTH';
}

const Login: React.FC<LoginProps> = ({ onLogin, mode = 'BOTH' }) => {
  return (
    <div className="max-w-md mx-auto mt-20 p-8 bg-[#111111] rounded-3xl shadow-[0_0_50px_rgba(242,194,0,0.1)] border border-[#333333] animate-in fade-in zoom-in duration-500">
      <div className="flex flex-col items-center mb-10 text-center">
        ...
        <h1 className="text-3xl font-black text-[#F2C200] tracking-tight">
          {mode === 'ADMIN' ? 'Staff Portal' : mode === 'CUSTOMER' ? 'Customer Portal' : BRAND_NAME}
        </h1>
        <p className="text-gray-400 text-sm mt-3 px-4">
          {mode === 'ADMIN' 
            ? 'Administrator and Engineer Login. Manage scheduling and fabrication contracts.' 
            : 'Access your commercial kitchen maintenance, warranties, and equipment quotes.'}
        </p>
      </div>
